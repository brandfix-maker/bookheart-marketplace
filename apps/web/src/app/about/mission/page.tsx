        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Building the future of book trading for the romantasy community
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-100">
              <div className="space-y-8">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  We're crafting our mission statement to perfectly capture our vision for the romantasy community. 
                  This page will share our core values, goals, and commitment to creating the best book trading experience.
                </p>
